...
function Home(){
    return (
    <div>
        <Hero title="The dedicated platform for health in the Central Valley." subtitle="Find local doctors and search for symptoms affecting you." image="/images/doctor.jpg" alt="doctors"/>
